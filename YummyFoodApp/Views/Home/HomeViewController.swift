...
class HomeViewController: UIViewController {
    ...
    var specials : [Dish] = [
        .init(id: "id1", name: "Kebab", description: "Very delicious food and so spicy", image: "https://picsum.photos/100/200", calories: 34),
        .init(id: "id2", name: "meze", description: "This is my favourite disches , perfect", image: "https://picsum.photos/100/200", calories: 45)
    ]
